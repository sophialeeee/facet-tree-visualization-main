...
import { drawTreeDel } from '../src/draw-tree-del';
...
drawTreeNumber(svg,data,clickFacet,clickBranch, clickBranchAdd, 'yes')
...
async function clickBranch(facetId: number) {
